					...
					<div class="summary">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								...
								<em class="t-gray">满999.00另加20.00元，或满1999.00另加30.00元，或满2999.00另加40.00元，
									即可在购物车换购热销商品</em>
							</div>
						</div>
					</div>
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as s>
								<dl>
									...
									<#list s.attributeValue as o>
										<dd>
											<a href="javascript:;"
											   class="{{isSelected('${s.attributeName}','${o}') ? 'selected' : ''}}"
											   ng-click="selectSpec('${s.attributeName}','${o}');">
